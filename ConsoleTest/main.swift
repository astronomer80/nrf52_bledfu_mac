...
class BLEManager: NSViewController, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    func uartManager(){
        //self.selectedPeripheral.writeValue(<#T##data: Data##Data#>, for: <#T##CBDescriptor#>)
    }
}
